<html <?php echo language_attributes();?>>
    ...
    <meta charset="<?php echo bloginfo();?>" />
        <?php wp_head();?>
    </head>
    <body <?php body_class();?>>
      <header class="site-header">
        <div class="container">
          <h1 class="school-logo-text float-left">
            <a href="<?php echo site_url();?>"><strong>Demo</strong> Logo</a>
          </h1>
          ...
          <div class="site-header__menu group">
            <nav class="main-navigation">
              ...
              ?><ul>
                ...
                <li <?php if (is_page('events')) echo 'class="current-menu-item"';?>><a href="<?php echo site_url('/blog'); ?>">Blog</a></li>
              </ul>
            </nav>
